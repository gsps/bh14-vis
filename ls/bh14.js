...
(function(){
  var V3, mod, clamp, Vis, BEATS_PER_BAR, VisState, Tri, Sequence, ManualSequence, SidestepSequence, ShearSequence, TranslateSequence, main;
  V3 = function(x, y, z){
  ...
  VisState = (function(){
    ...
    function VisState(time, running, perspCam, bpm, phase, params){
      ...
      this.seqs = [new ShearSequence(), new TranslateSequence(), new SidestepSequence()];
  ...
  ManualSequence = (function(superclass){
    var prototype = extend$((import$(ManualSequence, superclass).displayName = 'ManualSequence', ManualSequence), superclass).prototype, constructor = ManualSequence;
    ...
    function ManualSequence(){
      ManualSequence.superclass.apply(this, arguments);
    }
  ...
  main = function(){
    ...
    sampleRatio = 2;
    init = function(){
      var bloomPass, dotScreenPass, glitchPass, x$, y$, z$;
      fetchCanvasSize();
