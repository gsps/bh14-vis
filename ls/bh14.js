...
(function(){
  var prelude, V3, mod, clamp, Vis, BEATS_PER_BAR, VisState, Tri, Sequence, SidestepSequence, WaveSequence, ShearSequence, TranslateSequence, CircleSequence, MeteorSequence, main;
  ...
  VisState = (function(){
    ...
    function VisState(time, dt, running, perspCam, bpm, phase, params){
      ...
      this.seqs = [new MeteorSequence(), new WaveSequence(), new CircleSequence(), new ShearSequence(), new TranslateSequence(), new SidestepSequence()];
